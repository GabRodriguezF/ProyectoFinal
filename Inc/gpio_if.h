...
typedef uint8_t (*gpio_btn_read_fn_t)(void);
...
// ================================= Interfaz: Botones (PB0/PB1/PB2/PB3/PB4) =================================

typedef struct
{
	gpio_void_fn_t init;     // configura PB0/1/2/3/4 como entrada
    gpio_btn_read_fn_t btn_0;
    gpio_btn_read_fn_t btn_1;
    gpio_btn_read_fn_t btn_2;
    gpio_btn_read_fn_t btn_3;
    gpio_btn_read_fn_t btn_4;
} gpio_btn_if_t;
